...
const GOOGLE_VISION_API_KEY = "AIzaSyBLRqSZYWtopubDOss5myeW_9pcWeKKgl4"
...
function extractTextFromResponse(data: any, options: OCROptions): string {
  ...
  // Process document text detection
...
function fixCapitalization(text: string): string {
  ...
  const properNouns = [
    "road", "street", "avenue", "boulevard", "lane", "drive", "circle",
    "court", "place", "square", "terrace", "trail", "way", "north", "south",
